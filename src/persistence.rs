...
mod persistence_integrity_tests {
    ...
    async fn test_investigation_note_storage() {
        ...
        let note = InvestigationNote {
            ...
            evidence_points: vec![
                ...
                "Several documented modules are not wired into startup.".into(),
            ],
    ...
    async fn test_workflow_memory_note_storage() {
        ...
        let note = WorkflowMemoryNote {
            ...
            implementation_summary: "Adjusted parser edge-case handling for empty inputs.".into(),
            deliverables: vec!["change plan".into(), "verification summary".into()],
            verification_checks: vec!["run cargo build".into()],
            verification_commands: vec!["cargo build".into(), "cargo test --lib".into()],
            verification_summary: "cargo build passed".into(),
            risk_summary: "Malformed-token coverage may still be incomplete.".into(),
            evaluator_summary: "sections=6 quality=3".into(),
